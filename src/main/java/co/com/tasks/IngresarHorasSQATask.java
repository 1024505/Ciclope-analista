...
public class IngresarHorasSQATask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        try {
            leerExcel = Excel.leerDatosDeHojaDeExcel("Data/DatosCiclopePerfilAnalista.xlsx", "IngresarHorasSQA");
        } catch (IOException e) {
    ...
    public static IngresarHorasSQATask ingresarHorasSQA() {
        return instrumented(IngresarHorasSQATask.class);
    }
