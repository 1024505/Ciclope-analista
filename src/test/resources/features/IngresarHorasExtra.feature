#language: es
Característica: Realizar Ingreso Horas Extra

  El usuario se encuentra en el modulo de Hoja de Tiempo
  Busca y ingresa el tipo de hora que corresponde a horas extra
